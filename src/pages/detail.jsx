    ...
    <div className="max-sm:h-auto sm:h-[30rem] pt-8 px-6">
      ...
      <div className="relative border">
        ...
        <span className="absolute top-4 right-4">
            <RxCrossCircled className="text-xl text-black cursor-pointer" onClick={goBack}/>
        </span>

        <div className="flex justify-center p-2 mb-6 items-center">
         
          <div className="flex flex-col justify-center items-center text-center">
            <img src={product.thumbnail} alt={product.title} className="max-sm:h-44 sm:h-52 items-center" />
            <h2 className="max-sm:text-xl sm:text-2xl mt-4">{product.title}</h2>
